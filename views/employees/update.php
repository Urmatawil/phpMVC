    ...
    <div class="card-body">
        ...
        <form action="" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" required value="<?php echo $employee->name; ?>" class="form-control" name="name" id="name" aria-describedby="helpId" placeholder="John Doe">
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input required type="email" value="<?php echo $employee->email; ?>" class="form-control" name="email" id="email" aria-describedby="emailHelpId" placeholder="user@email.com">
            </div>
